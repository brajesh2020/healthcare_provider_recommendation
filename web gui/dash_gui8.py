    ...
    html.Div([
        dcc.DataTable(
            ...
            columns=[
                ...
                {'name': 'Indicator Name', 'id': 'Indicator Name'},
                {'name': 'Year', 'id': 'Year'},
                {'name': 'Value', 'id': 'Value'},
            ],
...
def update_search_results(n_clicks, selected_search, search_query):
    ...
    if selected_search is not None:
        ...
        return fig, dash.no_update, [{'label': i, 'value': idx} for idx, i in enumerate(last_10_search_results)]
...
def update_search_table(n_clicks, search_query):
    global last_10_search_results
    ...
    return last_10_search_results[0].to_dict('records')
